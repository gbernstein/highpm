...
#SBATCH --output=/home2/vwetzell/ProperMotion/pm_auxnew02/out_%a.log     # Output log (must exist before submit)
#SBATCH --error=/home2/vwetzell/ProperMotion/pm_auxnew02/err_%a.err      # Error log (must exist before submit)
