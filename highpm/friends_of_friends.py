def find_friend(data, length, cores=None):
    """Finds friends within a specified distance using either a BallTree or parallel
    query.
...
def friends_of_friends(list_friends):
    """Finds groups of friends-of-friends in a friendship network. Given a list where
    each element contains the indices of direct friends for each person, this function
    identifies all connected groups (including indirect connections via friends-of-
    friends).
    ...
    result : list of list of int
        ...
        people who are all connected directly or indirectly through friendships.
    Examples
    --------
